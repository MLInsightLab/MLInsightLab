...
#  Default: ''
# c.JupyterHub.pid_file = '/srv/jupyterhub/jupyterhub-proxy.pid'
...
c.Spawner.cmd = ['bash', '/srv/jupyter/jupyterhub-singleuser.sh']
...
def pre_spawn_hook(spawner):
    ...
    try:
        ...
        if role in ['admin', 'data_scientist']:
            ...
            check_call(['adduser', username.lower(), 'mlil'])
